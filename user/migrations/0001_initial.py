    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_value', models.CharField(blank=True, max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='ServiceType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_cat', models.CharField(choices=[('', '-- انتخاب کنید'), ('khodro', 'سواری شخصی'), ('khodro_dolati', 'سواری دولتی'), ('vanet', 'وانت شخصی'), ('vanet_doulati', 'وانت دولتی'), ('motor', 'موتور سیکلت'), ('taxi', 'تاکسی')], default='', max_length=150)),
                ...
                ('color_classes', models.TextField(blank=True)),
                ('first_name', models.CharField(blank=True, max_length=255)),
                ('last_name', models.CharField(blank=True, max_length=255)),
                ('finall_message', models.CharField(blank=True, default='', max_length=255)),
                ('customer_time', models.CharField(blank=True, max_length=30)),
                ('customer_date', models.CharField(blank=True, max_length=30)),
                ('time1', models.CharField(blank=True, max_length=30)),
                ('time2', models.CharField(blank=True, max_length=30)),
                ('time3', models.CharField(blank=True, max_length=30)),
                ('time4', models.CharField(blank=True, max_length=30)),
                ('date1', models.CharField(blank=True, max_length=30)),
                ('date2', models.CharField(blank=True, max_length=30)),
                ('date3', models.CharField(blank=True, max_length=30)),
                ('date4', models.CharField(blank=True, max_length=30)),
